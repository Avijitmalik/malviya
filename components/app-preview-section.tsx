          ...
          >
            ...
            <div className="flex flex-row lg:flex-row xs:flex-row items-center justify-center lg:justify-start gap-4 sm:gap-6">
              <a
                ...
                className="flex items-center gap-3 bg-white text-black px-6 py-2.5 rounded-xl hover:bg-gray-100 transition-all hover:scale-105 active:scale-95 shadow-lg w-full xs:w-auto"
              >
                <svg
                  className="w-7 h-7"
                  viewBox="0 0 24 24"
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[10px] leading-tight uppercase tracking-wider font-medium text-gray-500">
                    Download on the
                  </span>
              ...
              >
                ...
                <div className="flex flex-col items-start">
                  <span className="text-[10px] leading-tight uppercase tracking-wider font-medium text-gray-500">GET IT ON</span>
                  <span className="text-sm font-bold leading-tight">
                    Google Play
                  </span>
                </div>
